...
export default function SOPList({ sops }: SOPListProps) {
  ...
  const categories = ['All', 'Airport', 'Hotel', 'Logistics', 'Ziarah'];
  ...
  return (
    <div className="space-y-4" id="sop-section">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-2" id="sop-controls">
        <div className="lg:col-span-4 relative">
          ...
          <input
            ...
            className="w-full pl-8 pr-3 py-1.5 text-xs bg-white border border-slate-200 rounded focus:outline-none focus:ring-1 focus:ring-[#D4AF37] placeholder:text-slate-400"
          />
        </div>
        
        <div className="lg:col-span-8 flex flex-wrap gap-1 items-center">
          <div className="flex items-center gap-1 text-[10px] text-slate-400 font-bold mr-1">
